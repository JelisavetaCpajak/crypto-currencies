  ...
  data: [
    {
      ...
      DAILY_CHANGE_RELATIVE: (0.0175).toFixed(2),
    ...
    },
    {
      ...
      DAILY_CHANGE_RELATIVE: (-0.0185).toFixed(2),
      LAST_PRICE: 49650,
      VOLUME: 4395.3008469,
      HIGH: 49711,
      LOW: 48219,
    },
    {
      ...
      DAILY_CHANGE: -0.06,
      DAILY_CHANGE_RELATIVE: (-0.0003).toFixed(2),
      LAST_PRICE: 181.93,
    ...
    },
    {
      ...
      DAILY_CHANGE_RELATIVE: (-0.0178).toFixed(2),
      LAST_PRICE: 0.003667,
    ...
    },
    {
      ...
      DAILY_CHANGE_RELATIVE: (-0.0119).toFixed(2),
      LAST_PRICE: 0.066038,
